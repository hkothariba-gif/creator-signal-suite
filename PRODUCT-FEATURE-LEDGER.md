...
| W0-A11Y-001 | Accessible forms and validation | in-review | W0-UI-005 | Named labels, URL/email validation and associated error/help text work with keyboard and screen reader. | Browser accessible-name inventory; invalid/valid URL and email states; associated budget help; file extension/MIME guard; typecheck/build. | UIUX B5 forms; AUDIT §§3–4 | None | Review B5 forms checkpoint. |
