...
| W0-A11Y-003 | Shared modal and confirmation behavior | in-review | W0-UI-003 | App overlays share dialog semantics, focus trap, Escape/backdrop handling and focus restoration; destructive actions name consequences. | Browser keyboard checks for campaign creation, campaign intelligence, creator outreach, mobile navigation and destructive confirmations; typecheck/build. Component coverage follows in W0-QA-001. | UIUX B5 modals; AUDIT H8 | None | Review B5 modal/confirmation checkpoint. |
