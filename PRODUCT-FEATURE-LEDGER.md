...
| W0-A11Y-004 | Visible focus and persistent feedback hooks | in-review | W0-A11Y-001,W0-A11Y-002 | Every interactive control has a visible focus ring and toast output is announced politely. | Browser keyboard sweep across native and ARIA controls; visual focus check; toast region `aria-live="polite"` inspection; typecheck/build. Automated coverage follows in W0-QA-001. | UIUX B5 focus | None | Review B5 focus/feedback checkpoint. |
