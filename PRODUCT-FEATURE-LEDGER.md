...
| W0-UI-005 | Responsive wide-data treatment | in-review | W0-UI-004 | Simple tables stack below `sm`; unavoidable wide data and hotlist board scroll with a visible right-edge affordance; no unexplained route overflow remains at 375 px. | All `/app` routes at 375 px found no document overflow; affiliate and hotlist regions were measured and manually scrolled; typecheck/build. | UIUX B4.3; AUDIT C7 | None | Review B4.3 checkpoint. |
