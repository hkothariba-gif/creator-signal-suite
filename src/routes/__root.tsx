...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "AspenReach Landing is a marketing page for a B2B SaaS platform that connects brands with YouTube, Reddit, and X creators." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "AspenReach Landing is a marketing page for a B2B SaaS platform that connects brands with YouTube, Reddit, and X creators." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "AspenReach Landing is a marketing page for a B2B SaaS platform that connects brands with YouTube, Reddit, and X creators." },
    ...
    links: [
      ...
      // Aspen design faces (landing / login / signup / onboarding).
      {
        rel: "stylesheet",
