...
function AdminPage() {
  ...
  return (
    <div className="min-h-screen bg-bg-base text-brand-ink">
      <header className="h-[60px] bg-bg-surface border-b border-white/[0.07] px-8 flex items-center justify-between">
                  ...
                  <li key={key} className="flex items-center justify-between">
                    ...
                    <span
                      ...
                      style={{
                        ...
                        color: ok ? "var(--color-brand-green)" : "var(--color-brand-muted)",
                      }}
                    >
